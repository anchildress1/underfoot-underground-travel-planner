...
OPENAI_API_KEY, OPENAI_MODEL, DEFAULT_RADIUS_MILES, MAX_RADIUS_MILES, CACHE_TTL_SECONDS, SERPAPI_KEY, EVENTBRITE_TOKEN, REDDIT_CLIENT_ID, GOOGLE_MAPS_API_KEY, SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, SUPABASE_SECRET_KEY
